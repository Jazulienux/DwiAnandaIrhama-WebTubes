...
<div class="menu">
  ...
  <a href="tampiluser.php">Wisata Kota Malang</a>
...
<?php 
$data = mysqli_query($mysqli,"SELECT * FROM lokasi"); // memberikan perintah query sql untuk menampilkan semua data di tabel jual
